...
### 步骤
 ...
 3. 修改 `README.md`，将 `zjjibo/hero_git_wall` 替换为自己的内容（如 `example/demo`）

> [![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/zjjibo/hero_git_wall)
